...
const AuthBackground = () => {
  ...
  return (
    ...
    >
      {/* <img
                src={`${bg_login}?w=164&h=164&fit=crop&auto=format`}
                srcSet={`${bg_login}?w=164&h=164&fit=crop&auto=format&dpr=2 2x`}
                alt={'item.title'}
                loading="lazy"
                width="100%" height="calc(100vh - 175px)" viewBox="0 0 405 809" fill="none" xmlns="http://www.w3.org/2000/svg"
            /> */}
      <svg
        width="100%"
